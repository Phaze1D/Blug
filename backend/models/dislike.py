...
class Dislike(ndb.Model):
    """ A datastore ndb model that represents a Dislike
    ...
    def already_exist(cls, post_id, user_id):
        ...
        Returns:
            True if there is a dislike with the same user and post
        """
    ...
    def get_by_post_user(cls, post_id, user_id):
        ...
        Returns:
            The dislike that has a Post Key and User Key with the
            corrsponding ids
        """
